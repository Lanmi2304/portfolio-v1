...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="bg-background border-muted w-full border-t font-sans md:px-10"
      ref={containerRef}
    >
      <div className="mx-auto max-w-7xl px-4 py-20">
        ...
        <p className="max-w-lg text-sm text-neutral-700 md:text-base dark:text-neutral-300">
